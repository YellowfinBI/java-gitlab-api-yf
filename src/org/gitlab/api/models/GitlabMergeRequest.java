...
public class GitlabMergeRequest extends GitlabObject{
    ...
    private Boolean mergeWhenBuildSuccess;

	public Object isMergeWhenBuildSuccess() {
		return this.mergeWhenBuildSuccess;
	}
