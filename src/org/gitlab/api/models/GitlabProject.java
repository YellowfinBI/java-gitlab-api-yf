...
public class GitlabProject extends SimpleModule{
   ...
   private boolean onlyAllowMergeIfBuildSucceeeds;
   
   @JsonProperty("only_allow_merge_if_all_discussions_are_resolved")
   private boolean onlyAllowMergeIfAllDiscussionsAreResolved;
   
   public boolean isOnlyAllowMergeIfAllDiscussionAreResolved(){
	   return this.onlyAllowMergeIfAllDiscussionsAreResolved;
   }
   
   public boolean isOnlyAllowedMergeIfBuildSucceeds(){
	   return this.onlyAllowMergeIfBuildSucceeeds;
   }
   ...
   public Integer getOpenIssuesCount(){
    ...
    /* implemented to be a key in hashmap */
    @Override
    public int hashCode() {
        return this.id;
    }
    ...
    {
        return this.getId().equals(((GitlabProject)o).getId());
    }
    
    
    /* override to string in case that serilazer id not working */
