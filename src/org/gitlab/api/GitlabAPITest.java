...
public class GitlabAPITest {
    ...
    private static final String TEST_URL = System.getProperty("TEST_URL", "http://vm-gitlab.melbourne.yellowfin.bi");
    private static final String TEST_TOKEN = System.getProperty("TEST_TOKEN", "Dkx-vk1yozHRHA2nm8kR");

    String rand = UUID.randomUUID().toString().replace("-", "").substring(0, 8);

    @Before
    public void setup() throws IOException {
        api = GitlabAPI.connect(TEST_URL, "v3",TEST_TOKEN);
        try {
  ...
  //      Assert.assertNotEquals(postUpdate.getValue(), variable.getValue());
